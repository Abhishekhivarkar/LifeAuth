import { submitLifeStatus ,reviewLifeStatus,getLifeStatusPendingRecords} from "../controllers/core/index.js";
...
// Admin Routes
router.patch("/life-status/review/:recordId",authMiddleware,roleMiddleware("ADMIN"),reviewLifeStatus)
